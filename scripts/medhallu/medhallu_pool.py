...
``chpc_panel/medhallu_pairs_with_questions.csv`` column for column (verified 2026-09-05).
"""
...
POOL_CSV = os.path.join(_HERE, "chpc_panel", "medhallu_pairs_with_questions.csv")

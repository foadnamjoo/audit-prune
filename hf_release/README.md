...
@misc{namjoo2026judging,
  ...
  author = {Namjoo, Foad and Ogasawara, Remy and Abdullah, Amirali and Anderson, Cullen and Oozeer, Narmeen Fatimah and Phillips, Jeff M.},
  year   = {2026},
  note   = {Preprint},
  url    = {https://github.com/foadnamjoo/audit-prune}
}
```
